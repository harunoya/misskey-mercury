...
export type ILinkedAccountsCreateSubRequest = operations['i___linked-accounts___create-sub']['requestBody']['content']['application/json'];
export type ILinkedAccountsCreateSubResponse = operations['i___linked-accounts___create-sub']['responses']['200']['content']['application/json'];
export type ILinkedAccountsLinkRequest = operations['i___linked-accounts___link']['requestBody']['content']['application/json'];
export type ILinkedAccountsLinkResponse = operations['i___linked-accounts___link']['responses']['200']['content']['application/json'];
export type ILinkedAccountsListResponse = operations['i___linked-accounts___list']['responses']['200']['content']['application/json'];
export type ILinkedAccountsUnlinkRequest = operations['i___linked-accounts___unlink']['requestBody']['content']['application/json'];
export type ILinkedAccountsUnlinkResponse = operations['i___linked-accounts___unlink']['responses']['200']['content']['application/json'];
